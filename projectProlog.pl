...
uri(Input):- string_codes(Input, List_codes),
              ...
              atom_codes(Atom, List_codes),
              P is Pos - 1,
              sub_atom(Atom, 0, P, After, SubAtomScheme),
              scheme(SubAtomScheme),
              A is After - 1,
              sub_atom(Atom, Pos, A, _, SubAtomRest),
...
controlrest(Input):- atom_codes(Input, List_codes),
                     ...
                     P is Pos - 1,
                     atom_codes(Atom, List_codes),
                     sub_atom(Atom, 0, P, After, SubAtomAuthority),
                     authority(SubAtomAuthority),
                     A is After - 1,
                     sub_atom(Atom, Pos, A, _, SubAtomRest),
...
controlquestion(Input):- atom_codes(Input, List_codes),
                         ...
                         P is Pos - 1,
                         atom_codes(Atom, List_codes),
                         sub_atom(Atom, 0, P, After, SubAtomQuery),
                         path(SubAtomQuery), !.

controlquestion(Input):- atom_codes(Input, List_codes),
                         length(List_codes, Length_list),
                         member(63, List_codes), !,
                         listPos(List_codes, 63, Pos),
                         P is Pos - 1,
                         L is Length - 1,
                         atom_codes(Atom, List_codes),
                         sub_atom(Atom, P, L, _, SubAtomQuery),
                         query(SubAtomQuery), !.
